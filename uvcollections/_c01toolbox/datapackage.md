...
#### Accessibility
Once someone finds the required data, (s)he needs to know if and how they can be accessed, under which conditions and restrictions. FAIR does not mean that data need to be open!
...
- For more information about key file preservation, see here (link to working yet)
...
- This checklist may not be complete yet for studies falling under the Dutch law ('WMO-plichtige')
...
- For archiving paper-based (non-digital) data, check the [corresponding chapter]({{ site.baseurl }}/nondigitalarchiving) (work in progress)
...
6. GO FAIR website, FAIR principles. [https://www.go-fair.org/fair-principles/](https://www.go-fair.org/fair-principles/)
7. OECD (2007). Principles and Guidelines for Access to Research Data from Public Funding. OECD Publishing, Paris. [https://www.oecd.org/sti/inno/38500813.pdf](https://www.oecd.org/sti/inno/38500813.pdf)
8. Image FAIR data principles from: [https://book.fosteropenscience.eu/en/](https://book.fosteropenscience.eu/en/)
